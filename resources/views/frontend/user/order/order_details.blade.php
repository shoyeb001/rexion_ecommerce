            ...
            <div class="row">
                                            ...
                                            <td class="col-md-3">
                                                <div>
                                                    <div class="barcode; text-align: center; align-content: center;"
                                                        style="background-color: white; padding-top: 1rem; padding-left: 1rem; display: block;">
                                                        {!! DNS1D::getBarcodeHTML($item->product->product_code, 'C128', 1.6, 25) !!}
                                                        <p style="padding-left: 1rem;" class="pid">
                ...
                @else
                    ...
                    @else
                        ...
                        <span class="badge badge-pill badge-warning" style="background: red">You Have send return request
