        ...
        <div class="col-xs-12 col-sm-6 col-md-3">
          ...
          <div class="module-body">
            <ul class='list-unstyled'>
             ...
             <li class="first"><a title="Your Account" href="{{route("privacy")}}">Privacy & Policy</a></li>
            <li class="first"><a title="Your Account" href="{{route("terms")}}">Terms & Condition</a></li>
            <li class="first"><a title="Your Account" href="{{route("disclaimer")}}">Discliamer</a></li>
