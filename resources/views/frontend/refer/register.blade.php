        ...
        <div class="sign-in-page">
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 create-new-account">
                    <h4 class="checkout-subtitle">Refer & Earn</h4>
                    <p class="text title-tag-line" style="color:red">{{session('msg')}}</p>
                    <form class="register-form outer-top-xs" method="POST" action="{{route('refer.signup')}}"
                        role="form">
                        @csrf
                        <div class="form-group">
                            <label class="info-title" for="exampleInputEmail2"> Phone<span>*</span></label>
                            <input type="number" name="phone" class="form-control unicase-form-control text-input"
                        ...
                        <div class="form-group">
                            ...
                            <select name="payment_method" class="form-control" required="" >
                                ...
                                <option value="bank_transfer">Bank Transter</option>	
