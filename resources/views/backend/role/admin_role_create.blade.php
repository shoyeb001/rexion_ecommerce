...
<div class="col-md-4">
	<div class="form-group">
		...
		<div class="controls">			
			...
			<fieldset>
				<input type="checkbox" id="checkbox_17" name="refer_earn" value="1">
...
<div class="col-md-4">
	<div class="form-group">
		...
		<div class="controls">			
			<fieldset>
				<input type="checkbox" id="checkbox_18" name="pickup_center" value="1">
				<label for="checkbox_18">Pickup center</label>
			</fieldset>
			<fieldset>
				<input type="checkbox" id="checkbox_19" name="invoice" value="1">
