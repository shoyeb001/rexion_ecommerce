                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    <h5>Pickup Center Select <span class="text-danger">*</span></h5>
                                                    <div class="controls">
                                                        <select name="pickup_center" class="form-control">
                                                            <option value="" {{$products->pickup_center == "" ? 'selected' : ''}} disabled="">All
                                                            </option>

                                                            @foreach ($pickup_center as $data)
                                                                <option value="{{ $data->id }}"
                                                                    {{ $data->id == $products->pickup_center ? 'selected' : '' }}>
                                                                    {{ $data->name }}</option>
                                                            @endforeach
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <a class="btn btn-success" href="{{route("download.barcode",$products->product_code)}}">Download</a>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="number" name="purchase_price" class="form-control"
                                                            required="" value="{{ $products->purchase_price }}" step="0.01">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="number" name="selling_price" class="form-control"
                                                            required="" value="{{ $products->selling_price }}" step="0.01">
                                                        @error('selling_price')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="number" name="discount_price" class="form-control"
                                                            value="{{ $products->discount_price }}" step="0.01">
